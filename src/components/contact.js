                ...
                <div id='contact' className='box-shadow-full'>
                  <div className='row'>
                    <div className='col-md-6'>
                      ...
                      <div>
                        <form action='https://getform.io/f/be8cf65a-8d5b-4214-9f98-a9168e15d166' method='POST' className='contactForm'>
                    ...
                    <div className='col-md-6'>
                      ...
                      <div className='more-info'>
                        ...
                        <ul className='list-ico'>
                          <li>
                            <span className='ion-ios-location'></span> Antalya, Turkey{' '}
                          </li>
                          <li>
                            <a href='mailto:dima.dev.919@gmail.com'>
                              <span className='ion-email'></span>{' '}
                            </a>{' '}
                            dima.dev.919@gmail.com
                          </li>
                        </ul>
                      </div>
                      <div className='socials'>
                        <ul>
                          <li>
                            <a href='https://github.com/baranau1029' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='col-sm-12'>
                <div className='copyright-box'>
                  <p className='copyright'>
                    2022 &copy; Copyright <strong>Dzmitry Baranau</strong>.
                  </p>
                </div>
              </div>
            </div>
